    ...
    <div>
        <div id="home" class="d-flex flex-column flex-wrap align-items-center">
            ...
            <div class="card-container mb-3 d-flex flex-row justify-content-center justify-content-sm-start col-xxl-8 rounded container bg-light py-5">
                ...
                <!-- card -->
                <a class="card-link" href="https://etwincorp.com/P3_19072021" target="_blank">
                    <div class="card-right card m-3 my-3 border-4 border-white" style="width: 25rem">
                        ...
                        <div class="card-body">
                            ...
                            <hr />
                            <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                                <img src="../assets/node.svg" width="60" alt="node.js" title="node.js" />
                                <img src="../assets/javascript.svg" width="40" height="40" alt="javascript"
                                    title="Javascript" />

                                <img src="../assets/sass.svg" width="30" alt="Sass" title="Sass" />
                                <img src="../assets/html.svg" width="40" height="40" alt="html" title="html 5" />
                            </p>
                            <div class="d-flex flex-column">
                                <a href="https://etwincorp.com/P3_19072021" target="_blank"
                                    class="btn btn-primary px-3 mx-auto my-1">Try the app</a>
                                <a href="https://github.com/DamienLopvet/P3_19072021" target="_blank"
            ...
            <div
                ...
                <!-- card -->
                <a href="https://etwincorp.com/resatest" target="_blank" class="card-link">
                    <div class="card-left card m-3 my-3 border-4 border-white" style="width: 25rem">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                                ...
                                <img src="../assets/reactrouter.svg" width="40" alt="reactRouter.js"
                                    title="reactRouter.js" />
                                <img src="../assets/GgAPI.png" width="40" height="40" alt="Google api"
                                    title="Google calendar api" />
                            </p>
                            <div class="d-flex flex-column">
                                <a href="https://etwincorp.com/resatest" target="_blank"
                                    class="btn btn-primary px-3 mx-auto my-1">Try the app</a>
            ...
            <div
                ...
                <!-- card -->
                <a href="https://etwincorp.com/frontestG" target="_blank" class="card-link">
                    <div class="card-right card m-3 mx-3 my-3 border-4 border-white" style="width: 25rem">
                        <div class="card-image rounded border border-primary">
                            <img src="..\assets\Groupomania.webp" width="100%" loading="lazy"
                                alt="groupomania-screenshot" />
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Groupomania</h3>
                            <p class="card-text">
                                This is my graduating project, I made an API and the
                            ...
                            <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                                ...
                                <img src="../assets/express.svg" width="30" alt="express.js" title="express.js"
                                    class="px-1" />
                                <img src="../assets/sql.svg" width="40" alt="SQL" title="SQL" class="px-1" />
                                <img src="../assets/react.svg" width="40" alt="react.js" title="react.js" />
                                <img src="../assets/html.svg" width="40" height="40" alt="html" title="html 5" />
                            </p>
                            <div class="d-flex flex-column">
                                <a href="https://etwincorp.com/frontestG" target="_blank"
                                    class="btn btn-primary px-3 mx-auto my-1">Try the app</a>
                                <div>
                                    <a href="https://github.com/DamienLopvet/Groupomania-frontend" target="_blank"
                                        class="btn btn-outline-primary mx-auto my-1">Frontend code</a>
                                    <a href="https://github.com/DamienLopvet/Groupomania-bakckend" target="_blank"
                                        class="btn btn-outline-primary mx-auto my-1">Backend code</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--FACE RECOGNITION-->
            <div
                class="card-container mb-3 d-flex flex-row justify-content-center justify-content-sm-start col-xxl-8 rounded container bg-light py-5ed container bg-light py-5">
                <div class="growing-box d-none d-sm-block"></div>

                <!-- card -->
                <a href="https://etwincorp.com/faceRecognition" target="_blank" class="card-link">
                    <div class="card-left card m-3 my-3 border-4 border-white" style="width: 25rem">
                        <div class="card-image rounded border border-primary">
                            <img src="..\assets\faceRecognition.jpg" width="100%" loading="lazy"
                                alt="multiple-stopwatches-screenshot" class="image" />
                        </div>
                        <div class="card-body">
                            ...
                            <hr />
                            <p class="card-logos text-info d-flex justify-content-center gap-2 flex-wrap">
                                <img src="../assets/node.svg" width="60" alt="node.js" title="node.js" />
                                <img src="../assets/javascript.svg" width="40" height="40" alt="javascript"
                                    title="Javascript" />
                                <img src="../assets/css.svg" width="40" height="40" alt="Css" title="CSS 3" />
                                <img src="../assets/vue.svg" width="30" alt="Vue.js" title="Vue.js" />
            ...
            <div class="card-container mb-3 d-flex flex-row justify-content-center justify-content-sm-start col-xxl-8 rounded container bg-light py-5">
                ...
                <!-- card -->
                <a href="https://etwincorp.com/P6_08112021" target="_blank" class="card-link">
                    <div class="card-right card m-3 my-3 border-4 border-white" style="width: 25rem">
                        <div class="card-image rounded border border-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column">
                                <a href="https://etwincorp.com/P6_08112021" target="_blank"
                                    class="btn btn-outline-primary mx-auto my-1">See the code</a>
                            </div>
                        </div>
                    </div>
            ...
            <div
                ...
                <!-- card -->
                <a href="https://etwincorp.com/multiple-chronos" target="_blank" class="card-link">
                    <div class="card-left card m-3 my-3 border-4 border-white" style="width: 25rem">
                        <div class="card-image rounded border border-primary">
                            <img src="..\assets\multiple-chronos.webp" width="100%" loading="lazy"
                                alt="multiple-stopwatches-screenshot" />
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Multiple Stopwatches</h3>
                            <p class="card-text">
                                This app is for those who need to measure their time
                            ...
                            <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                                ...
                                <img src="../assets/html.svg" width="40" height="40" alt="html" title="html 5" />
                                <img src="../assets/vue.svg" width="30" alt="Vue.js" title="Vue.js" />
                                <img src="../assets/local-storage.svg" width="40" height="40" alt="Local storage"
                                    title="Local storage" />
                                <img src="../assets/mongoDb.svg" width="40" height="40" alt="MongoDB" title="MongoDB" />
                                <img src="../assets/mongoose.png" width="80" alt="Mongoose" title="Mongoose"
                                    style="translate: 0 -18px" />
                            </p>
                            <div class="d-flex flex-column">
                                <a href="https://etwincorp.com/multiple-chronos" target="_blank"
                                    class="btn btn-primary px-3 mx-auto my-1">Try the app</a>
                                <a href="https://github.com/DamienLopvet/multiple-chronos" target="_blank"
                                    class="btn btn-outline-primary mx-auto my-1">See the code</a>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            ...
            <div id="intern"
                ...
                <!-- card -->
                <a href="https://jhmediagroup.com/" target="_blank" class="card-link">
                    <div class="card-left card m-3 my-3 -lg border-4 border-white" style="width: 25rem">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                This Lightbox feature I built with Js is useful on
                                the
                                <a href="https://jhmediagroup.com/" target="_blank" class="link text-primary">homePage</a>
                                and the
                                <a href="https://jhmediagroup.com/company/" target="_blank"
                                    class="link text-primary">company</a>
                                page of
                                <a href="https://jhmediagroup.com/" target="_blank"
                                    class="link text-primary">jhMediaGroup</a>
                            </p>
                            <hr />
                            <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                                <img src="../assets/javascript.svg" width="40" height="40" alt="javascript"
                                    title="Javascript" />
                                <img src="../assets/wordpress.svg" width="40" height="40" alt="wordpress"
                                    title="wordpress" />
                                <img src="../assets/css.svg" width="40" height="40" alt="Css" title="CSS 3" />
                                <img src="../assets/html.svg" width="40" height="40" alt="html" title="html 5" />
                            </p>
                            <div class="d-flex flex-column">
                                <a href="https://jhmediagroup.com/" target="_blank" class="btn btn-primary mx-auto my-1">See
                                    the page</a>
                            </div>
                        </div>
                    </div>
            ...
            <div
                ...
                <div class="m-3 align-self-center col-7 d-none d-sm-block text-start flex-auto text-white">
                    ...
                    <p>
                        During my internship at
                        <a href="https://jhmediagroup.com/" target="_blank" class="link text-primary">jhMediaGroup</a>
                        we needed to optimize the Performances of the company's
                        website. I used
                        <a href="https://wordpress.org/plugins/w3-total-cache/" target="_blank" class="link text-primary">W3
                            total cache</a>, and lazy-load images. I set up the optimization
                        options in DIVI and I "defer" or "async" the Js scripts
                ...
                <div class="m-3 card-right card border-4 border-white" style="width: 25rem">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Increasing the performances of a
                            <a href="https://jhmediagroup.com/" target="_blank" class="link text-primary">website</a>
                            can be tricky, fortunately plugins and Js knowledge
                            are helpful
                        </p>
                        <hr />
                        <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                            <img src="../assets/wordpress.svg" width="40" height="40" alt="wordpress" title="wordpress" />
                            <img src="../assets/divi.svg" width="40" height="40" alt="Divi" title="Divi" />
                            <img src="../assets/javascript.svg" width="40" height="40" alt="javascript"
                                title="Javascript" />
                        </p>
                        <div class="d-flex flex-column">
                            <a href="https://pagespeed.web.dev/report?url=https%3A%2F%2Fjhmediagroup.com%2F" target="_blank"
                                class="btn btn-primary mx-auto my-1">See the perf</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="m-3 card-left card my-3 -lg border-4 border-white" style="width: 25rem">
                    <div class="card-image rounded border border-primary">
                        <img src="..\assets\jhgAccessibility.webp" width="100%" loading="lazy"
                            alt="accessibility-screenshot" />
                    </div>

                    <div class="card-body">
                        <h2 class="card-title">Accessibility</h2>
                        <p class="card-text">
                            As we refreshed the company's website we needed to
                            make some changes to fit the
                            <a href="https://www.ada.gov/" target="_blank" class="link text-primary">Ada Compliance</a>
                            requirements
                        </p>
                        <hr />
                        <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                            ...
                            <img src="../assets/javascript.svg" width="40" height="40" alt="javascript"
                                title="Javascript" />
                            <img src="../assets/wave.svg" height="40" alt="Wave evaluation tool"
                                title="Wave evaluation tool" />
                        </p>
                        <div class="d-flex flex-column">
                            <a href="https://jhmediagroup.com/" target="_blank"
                                class="btn btn-primary w-50 mx-auto my-1">Try it</a>
                        </div>
                    </div>
                </div>
                <div class="m-3 align-self-center col-7 d-none d-sm-block text-start flex-auto text-white">
            ...
            <div
                ...
                <div class="m-3 card-right card -lg border-4 border-white" style="width: 25rem">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            During my internship I spent a lot of time working
                            on this app. This was amazing, I learned a lot
                        </p>
                        <hr />
                        <p class="card-logos text-info d-flex justify-content-center flex-wrap gap-1">
                            <img src="../assets/docker.svg" width="40" height="40" alt="Docker" title="Docker" />
                            <img src="../assets/laravel.svg" width="40" height="40" alt="Laravel" title="Laravel" />
                            <img src="../assets/sql.svg" width="40" alt="SQL" title="SQL" class="px-1" />
                            <img src="../assets/vue.svg" width="30" alt="Vue.js" title="Vue.js" />
                        </p>
                        <div class="d-flex flex-column">
                            <a href="https://app.temptracker.io/" target="_blank"
                                class="btn btn-primary w-50 mx-auto my-1">Go there</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="py-3 mt-4 bg-dark">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <li class="nav-item">
                    <a href="#intern" class="nav-link px-2 text-muted">Internship</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="cv-damien-lopvet-francais.pdf" target="_blank" class="nav-link px-2 text-muted">My CV</a>
                </li>
            </ul>
        ...
        observCards() {
            ...
            function handleIntersect(entries, observer) {
                entries.forEach(function (entry) {
                    let growingBackgroundBox = entry.target.querySelector('.growing-box:first-child')
                    let appearingBackgroundBox = entry.target.querySelector('.appearing-box:first-child')
                    if (entry.intersectionRatio > prevRatio && growingBackgroundBox) {

                        growingBackgroundBox.style.scale = entry.intersectionRatio * 1.5;
                    }
                    if (entry.intersectionRatio > prevRatio && appearingBackgroundBox) {
                        appearingBackgroundBox.style.opacity = entry.intersectionRatio * 1.5;
                    }

                    if (entry.intersectionRatio * 1.5 >= 1) observer.unobserve(entry.target)
